...
* **[SIC_PMM_Main.pdf](./SIC_PMM_Main.pdf)**
    * *Contents include: Base-system rectification, derivation of the $\beta$-offset, settlement of the Hubble Tension, and definitions of discrete operators. / 內容涵蓋：數制修正、 `$\beta$-offset` 偏移推導、哈伯張力結算、離散算符定義。*
